...
function loadData() {
    ...
    var catalogURL = "http://localhost:8000/api/v1/catalog.json";
    $.ajax({
        url: catalogURL,
        dataType: 'json',
        crossDomain: false,
...
function sendTokenToServerGithub() {
    state = $("#state").data().value;
    var url = "https://github.com/login/oauth/authorize?client_id=dd0a2c1a63b1ff4d0f57&type=user_agent&redirect_uri=http://localhost:8000/gitconnect?state=" + state;
    window.location = url;
}
